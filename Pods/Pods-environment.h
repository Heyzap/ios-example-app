...
// Heyzap
#define COCOAPODS_POD_AVAILABLE_Heyzap
#define COCOAPODS_VERSION_MAJOR_Heyzap 6
#define COCOAPODS_VERSION_MINOR_Heyzap 2
#define COCOAPODS_VERSION_PATCH_Heyzap 2
