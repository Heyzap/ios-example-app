...
/** If set this offer will be displayed even when more than one are returned */
@property (nonatomic, assign, getter = isDefaultOffer) BOOL defaultOffer;

/** Array of class HYPROfferComponent objects for this offer */
